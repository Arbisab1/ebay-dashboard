...
return "Success" in res.text or "Warning" in res.text
...
--- STRICT SECURE SESSION STATE (NO URL PARAMETERS) ---
...
eBay Automation Portal
Secure Client Workspace & Automated Order Hub
...
Got questions or need help setting up?
...
Product Hunting & Competitor Policy Audit
""",
    unsafe_allow_html=True,
)
...
Listing Violations & Policy Health
""",
    unsafe_allow_html=True,
)
...
if not accessible_stores:
    ...
    if not fetch_all_sales_toggle:
        if sales_start_date > sales_end_date:
            ...
            sales_date_filter_key = f"{sales_start_date}T00:00:00.000Z..{end_date}T23:59:59.999Z"
...
Verified Email: {email_addr if email_addr else 'Not Added'}


Store Alias: {assigned}
